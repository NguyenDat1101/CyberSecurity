...
Khi xem bằng **Wireshark** ta có thể thấy quá trình nmap gửi đi **SYN** tới port chỉ định, nếu port mở host sẽ gửi lại một **SYN/ACK** và nmap sẽ gửi một **RST** kết thúc quá trình bắt tay.
